...
class BmwI3Battery : public CanBattery {
 ...
 private:
  ...
  static constexpr CAN_frame BMW_41D = {.FD = false, .ext_ID = false, .DLC = 4, .ID = 0x41D, .data = {0xFF, 0xF7, 0x7F, 0xFF}};
  CAN_frame BMW_433 = {.FD = false,
                       .ext_ID = false,
                       .DLC = 4,
                       .ID = 0x433,
                       .data = {0xFF, 0x00, 0x0F, 0xFF}};  // HV specification
  static constexpr CAN_frame BMW_512 = {.FD = false,
                       .ext_ID = false,
                       .DLC = 8,
                       .ID = 0x512,
  ...
  static constexpr CAN_frame BMW_6F1_SOH = {.FD = false, .ext_ID = false, .DLC = 5, .ID = 0x6F1, .data = {0x07, 0x03, 0x22, 0x63, 0x35}};
  static constexpr CAN_frame BMW_6F1_SOC = {.FD = false, .ext_ID = false, .DLC = 5, .ID = 0x6F1, .data = {0x07, 0x03, 0x22, 0xDD, 0xBC}};
  static constexpr CAN_frame BMW_6F1_CELL_VOLTAGE_AVG = {.FD = false,
                                        .ext_ID = false,
                                        .DLC = 5,
                                        .ID = 0x6F1,
                                        .data = {0x07, 0x03, 0x22, 0xDF, 0xA0}};
  static constexpr CAN_frame BMW_6F1_CONTINUE = {.FD = false, .ext_ID = false, .DLC = 4, .ID = 0x6F1, .data = {0x07, 0x30, 0x00, 0x02}};
