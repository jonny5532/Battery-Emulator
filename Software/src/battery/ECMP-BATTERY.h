...
class EcmpBattery : public CanBattery {
 ...
 private:
  ...
  static constexpr CAN_frame ECMP_0A6 = {.FD = false,
                        .ext_ID = false,
                        .DLC = 2,
                        .ID = 0x0A6,
  ...
  static constexpr CAN_frame ECMP_0AE = {.FD = false, .ext_ID = false, .DLC = 5, .ID = 0x0AE, .data = {0x04, 0x77, 0x7A, 0x5E, 0xDF}};
  ...
  static constexpr CAN_frame ECMP_37F = {.FD = false,      //??? 100ms periodic (Perfectly emulated in Battery-Emulator)
  ...
  static constexpr CAN_frame ECMP_ACK = {.FD = false,  //Ack frame
                        ...
                        .ID = 0x6B4,
                        .data = {0x30, 0x00, 0x00}};
  static constexpr CAN_frame ECMP_DIAG_START = {.FD = false, .ext_ID = false, .DLC = 3, .ID = 0x6B4, .data = {0x02, 0x10, 0x03}};
  ...
  static constexpr CAN_frame ECMP_RESET_DONE = {.FD = false, .ext_ID = false, .DLC = 3, .ID = 0x6B4, .data = {0x02, 0x3E, 0x00}};
  ...
  static constexpr CAN_frame ECMP_ACK_MESSAGE = {.FD = false, .ext_ID = false, .DLC = 3, .ID = 0x6B4, .data = {0x02, 0x3E, 0x00}};
